...
public class MainScreen implements Show {
    private App app;
    private Scene scene;
    ...
    private void mainScreen(){
        ...
        imageView6.setOnMouseClicked(e -> app.showAdminLoginScreen());
        ...
        btnLng.setOnAction(e -> app.showAdminLoginScreen());// scene berganti ke login admin
